...
from celero.api.models import User, Contabilidade
...
class ContabilidadeAdmin(admin.ModelAdmin):
    list_display = ['nome', 'valor', 'created', 'modified']
    search_fields = ['nome', 'valor']
    list_filter = ['nome', 'modified']


admin.site.register(Contabilidade, ContabilidadeAdmin)
