...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def clean(self):
        ...
        self.email = self.__class__.objects.normalize_email(self.email)  # pragma: no cover

    def get_full_name(self):
        """
        Return the first_name plus the last_name, with a space in between.
        """
        full_name = '%s' % (self.first_name)  # pragma: no cover
        return full_name.strip()  # pragma: no cover
